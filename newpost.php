...
<body>
    <div class="container">
         <h1 style="text-align: center;">Webboard PERM</h1>
         <?php
        include "nav.php"
        ?>
        <div class="row mt-4">
        ...
        <div class="col-lg-6 col-md-8 col-sm-10">
            <div class="card border-info">
                <div class="card-herder bg-info text-white">ตั้งกระทู้ใหม่</div>
                <div class="card-body">
                    <form action="newpost_save.php" method="post">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12 d-flex justify-content-lg-center">
                                <button type="submit" class="btn btn-info btn-sm text-while me-2">
